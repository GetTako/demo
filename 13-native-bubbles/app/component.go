// Package app provides the native bubbles demo components.
package app
...
// NativeInput is a demo component.
...
// NewNativeInput creates a new NativeInput.
...
func (n *NativeInput) Render() any {
	...
	fmt.Fprintf(&sb, "  Typed Text: %s\n\n", n.text)
	sb.WriteString("  (Type something, press ctrl+c to quit)\n")
	
	return sb.String()
}

// RegisterKeys registers keybindings.
func (n *NativeInput) RegisterKeys(_ contracts.KeyManager) {
